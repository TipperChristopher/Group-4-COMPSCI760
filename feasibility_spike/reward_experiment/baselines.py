# Vendored verbatim from branch desmond/reward-and-episode-fix:src/baselines.py
# (GapFollower = Follow-the-Gap; RandomPolicy). Reference copy for the baseline comparison.
