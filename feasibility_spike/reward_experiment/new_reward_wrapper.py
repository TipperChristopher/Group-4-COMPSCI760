# Vendored verbatim from branch desmond/reward-and-episode-fix (commit 129c7d1) sb3_wrapper.py — the NEW progress reward (Desmond Li). Do not edit; reference copy for the ablation.
